...
![рис.1. Евклид.](images/1.jpg){ #fig:001 width=90% }


2. Реализуем алгоритм p-метода Полларда. (рис. 2)


![рис.2. Поллард.](images/2.jpg){ #fig:002 width=90% }


3. Проверим работу алгоритма.


![рис.3. Проверка.](images/3.jpg){ #fig:003 width=90% }
